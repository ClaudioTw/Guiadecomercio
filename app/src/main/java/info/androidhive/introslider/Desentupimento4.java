...
public class Desentupimento4  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desentupimento4);
        ...
        TextSliderView aux1 = new TextSliderView(Desentupimento4.this);
        aux1.description("Casa Matriz - Ar Condicionado");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Desentupimento4.this);
        aux1.setOnImageLoadListener(Desentupimento4.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Desentupimento4.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Desentupimento4.this);
        aux2.image(R.drawable.fotomatrix2);
        aux2.setOnSliderClickListener(Desentupimento4.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Desentupimento4.this);
