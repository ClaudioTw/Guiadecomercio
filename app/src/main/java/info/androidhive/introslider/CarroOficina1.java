...
public class CarroOficina1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carro_oficina1);
        ...
        TextSliderView aux1 = new TextSliderView(CarroOficina1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(CarroOficina1.this);
        aux1.setOnImageLoadListener(CarroOficina1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(CarroOficina1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(CarroOficina1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(CarroOficina1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(CarroOficina1.this);
