...
public class ClinVeterinaria1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clin_veterinaria1);
        ...
        TextSliderView aux1 = new TextSliderView(ClinVeterinaria1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(ClinVeterinaria1.this);
        aux1.setOnImageLoadListener(ClinVeterinaria1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(ClinVeterinaria1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(ClinVeterinaria1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(ClinVeterinaria1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(ClinVeterinaria1.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String falar = "Clinica veterinária\n" +
                        "Veter\n" +
                        "Cães - gatos - e aves.\n" +
                        "Dr. Elton e - Dr. José\n" +
                        "\n" +
                        ...
                        "Raio X\n" +
                        "Banho e Tosa Trabalhamos 25 anos no mesmo local!\n" +
                        "\n" +
                        "Rsponsaveis\n" +
                        "Levamos e trazemos seu Pét.\n" +
                        "\n" +
                        "Horario de funcionamento.\n" +
                        "De segunda a sexta \n" +
                        "das 09:Hr00 Min ás 20Hr00\n" +
                        "\n" +
                        "e de sábado as\n" +
                        "09:Hr00 as 16Hr00\n" +
                        "\n" +
                        "Entre em contato conosco\n" +
                        "Telefone onze - 3975-5822 \n" +
                        " \n" +
                        "Faça nos uma visita no endereço.\n" +
                        "Av. Cabo Adão Pereira - nº87\n" +
                        "Pirituba - São Paulo.\n. " +
                        ""
                      .toString();
