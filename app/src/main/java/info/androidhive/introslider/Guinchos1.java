...
public class Guinchos1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.guinchos1);
        ...
        TextSliderView aux1 = new TextSliderView(Guinchos1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Guinchos1.this);
        aux1.setOnImageLoadListener(Guinchos1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Guinchos1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Guinchos1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(Guinchos1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Guinchos1.this);
