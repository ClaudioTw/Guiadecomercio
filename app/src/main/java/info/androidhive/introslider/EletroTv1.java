...
public class EletroTv1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eletro_tv1);

        b1 = (ImageView) findViewById(R.id.btnaudio);
        // SLIDERLAYOUT
        slImages = (SliderLayout) findViewById(R.id.slImages);

        TextSliderView aux1 = new TextSliderView(EletroTv1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(EletroTv1.this);
        aux1.setOnImageLoadListener(EletroTv1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(EletroTv1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(EletroTv1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(EletroTv1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(EletroTv1.this);
