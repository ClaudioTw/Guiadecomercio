...
public class Dedetizacao2  extends AppCompatActivity implements
    ...
    private String[] images = {
            ...
            "https://www.esgotecnica.com.br/wp-content/uploads/2015/03/central-de-atendimento.jpg",
            "https://www.esgotecnica.com.br/wp-content/uploads/2015/01/esgotecnica_estruturada01-1920x580.jpg",
            "https://www.esgotecnica.com.br/wp-content/uploads/2015/01/empresa_completa-1920x580.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dedetizacao2);
        ...
        TextSliderView aux1 = new TextSliderView(Dedetizacao2.this);
        aux1.description("\n" +
                "A Esgotecnica\n" +
                "\n" +
                "Oferece visita grátis, orçamento prévio, atendimento 24 horas, pagamento facilitado, desconto promocional e garantia de até 1 ano.\n");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Dedetizacao2.this);
        aux1.setOnImageLoadListener(Dedetizacao2.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Dedetizacao2.this);
        aux1.description("\n" +
                "\n" +
                "Empresa Estruturada\n" +
                "\n" +
                "A Esgotecnica possui estrutura capaz de atender residências, condomínios, empresas e órgãos públicos.\n");
        aux1.image(images[1]);
        aux1.setOnSliderClickListener(Dedetizacao2.this);
        aux1.setOnImageLoadListener(Dedetizacao2.this);
        slImages.addSlider(aux1);

        DefaultSliderView aux2 = new DefaultSliderView(Dedetizacao2.this);
        aux2.image(R.drawable.ddbras2);
        aux2.setOnSliderClickListener(Dedetizacao2.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Dedetizacao2.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String falar = "ESGOTÉCNICA\n" +
                        ...
                        "\n" +
                        "Nós somos  especialistas na detecção de vazamentos ocultos," +
                        " utilizamos vários tipos de equipamentos adequados para cada ocasião.\n" +
                        "\n" +
                        "Saiba mais\n" +
                        "Caça Vazamentos em Esgotos\n" +
                        "Localizamos vazamentos em tubulações de até 10\" polegadas, " +
                        "e em extensões de linha de até 20 metros, tubulações de esgotos," +
                        " águas pluviais, ramais de pias, saídas de vasos sanitários e etc.\n" +
                        "\n" +
                        "Saiba mais\n" +
                        "Caça Vazamentos de Infiltrações\n" +
                        "Localizamos qualquer infiltração que exista, por inspeção visual, " +
                        "nossos técnicos são treinados para fazer essa vistoria facilmente. " +
                        "Contrate hoje mesmo.\n" +
                        "\n" +
                        "Saiba mais\n" +
