...
public class Desentupimento1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desentupimento1);
        ...
        TextSliderView aux1 = new TextSliderView(Desentupimento1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Desentupimento1.this);
        aux1.setOnImageLoadListener(Desentupimento1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Desentupimento1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Desentupimento1.this);
        aux2.image(R.drawable.desentupimento);
        aux2.setOnSliderClickListener(Desentupimento1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Desentupimento1.this);
        aux2.description("Os Maiores Peixes com Caiaque");
        aux2.image(R.drawable.dedetizacao);
        aux2.setOnSliderClickListener(Desentupimento1.this);
        aux2.description("2");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Desentupimento1.this);
        aux2.image(R.drawable.dedetizacaoeratiza);
        aux2.setOnSliderClickListener(Desentupimento1.this);
        aux2.description("3");
        slImages.addSlider(aux1);
