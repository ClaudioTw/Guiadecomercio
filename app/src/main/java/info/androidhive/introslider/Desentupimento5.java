...
public class Desentupimento5  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desentupimento5);
        ...
        TextSliderView aux1 = new TextSliderView(Desentupimento5.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Desentupimento5.this);
        aux1.setOnImageLoadListener(Desentupimento5.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Desentupimento5.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Desentupimento5.this);
        aux2.image(R.drawable.desentupimento);
        aux2.setOnSliderClickListener(Desentupimento5.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Desentupimento5.this);
