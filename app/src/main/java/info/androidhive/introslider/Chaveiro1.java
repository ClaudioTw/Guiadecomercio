...
public class Chaveiro1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chaveiro1);
        ...
        TextSliderView aux1 = new TextSliderView(Chaveiro1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Chaveiro1.this);
        aux1.setOnImageLoadListener(Chaveiro1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Chaveiro1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Chaveiro1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(Chaveiro1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Chaveiro1.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String falar = "Chaveiro Parapuã\n" +
                        "\n" +
                        "Trabalhamos com aberturas de cofres\n" +
                        "Autos e e Residenciais\n" +
                        "Copi\ta Mult-T-Lock\n" +
                        "Trava elétrica\n" +
                        "Fechaduras e \n" +
                        "Reformas de vidros elétricos\n" +
                        "\n" +
                        "Emergência\n" +
                        "Ligue para onze - 3975-3559\n" +
                        "ou ligue 7836-7946 Id: 2*45144\n" +
                        "\n" +
                        "Venha nos fazer uma visita na Rua Parapuã - nº206 - \n" +
                        "Itaberaba - São Paulo. " +
                        ""
                        .toString();
