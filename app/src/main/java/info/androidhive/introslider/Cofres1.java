...
public class Cofres1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cofres1);
        ...
        TextSliderView aux1 = new TextSliderView(Cofres1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Cofres1.this);
        aux1.setOnImageLoadListener(Cofres1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Cofres1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Cofres1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(Cofres1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Cofres1.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String falar = "A.M. Cofres & Móveis para Escritório Ltda.\n" +
                        "\n" +
                        "Trabalhamos com um a variedade de cofres para industria - comercial  e - residencial.\n" +
                        "Temos diversos tamanhos - utilidades - e tipos , como - mecânicos, - ou digitais de embutir ou invisiveis.\n" +
                        "Móveis para escritório.\n" +
                        "\n" +
                        "Entre em contato no telefone \n" +
                        "Tel.:  onze - 4933-1972\n" +
                        "\n" +
                        "repetindo\n" +
                        " Tel.:  onze - 4933-1972\n" +
                        ...
                        "Av. Cásper Líbero, nº353 - República \n" +
                        "São Paulo \n" +
                        " Metro LUZ - CEP 01033-001\n" +
                        "\n" +
                        "nosso e-mail\n" +
                        "amcofres@amcofres.com.br\n" +
                        "\n" +
                        "Se quiser pode acessar nosso site pelo endereço.\n" +
                        "www.-amcofres. - com.br\n" +
                        "\n" +
                        "A.M. Cofres & Móveis para Escritório Ltda.\n " +
                        ""
                       .toString();
