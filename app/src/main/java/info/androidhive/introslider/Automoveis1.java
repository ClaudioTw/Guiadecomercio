...
public class Automoveis1  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.automoveis1);
        ...
        TextSliderView aux1 = new TextSliderView(Automoveis1.this);
        aux1.description("Pescarias Emocionantes");
        aux1.image(images[0]);
        aux1.setOnSliderClickListener(Automoveis1.this);
        aux1.setOnImageLoadListener(Automoveis1.this);
        slImages.addSlider(aux1);

        aux1 = new TextSliderView(Automoveis1.this);
        ...
        DefaultSliderView aux2 = new DefaultSliderView(Automoveis1.this);
        aux2.image(R.drawable.image_1);
        aux2.setOnSliderClickListener(Automoveis1.this);
        aux2.description("1");
        slImages.addSlider(aux2);

        aux2 = new DefaultSliderView(Automoveis1.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String falar = "Pilhados car\n" +
                        "Estética automotiva funilaria.\n" +
                        "\n" +
                        "Trabalhamos com estética automotiva - Pintura - Lavagem - polimento - higienização.\n" +
                        "\n" +
                        "Martelinho de ouro.\n" +
                        "Fazemos trabalhos artesanal.\n" +
                        "Mecânica especializada.\n" +
                        "Estética aplicada.\n" +
                        "\n" +
                        "Faça nos uma visita em um de nossos endereços.\n" +
                        "\n" +
                        "Ligue para agendar sua visita.\n" +
                        "\n" +
                        "Para estética aplicada.\n" +
                        "Av.Ministro petrônio Portela - nº1144 na Freguesia do ó - são paulo.\n" +
                        "Ligue no telefone.\n" +
                        "onze - 4306-6375\n" +
                        "repetindo\n" +
                        "onze - 4306-6375\n" +
                        "\n" +
                        "Para Pintura.\n" +
                        "Rua Maetra Pias Filippini - nº506 - Freguesia do ó - são paulo\n" +
                        "Ligue no telefone.\n" +
                        "onze - 3297-5982\n" +
                        "repetindo.\n" +
                        "onze - 3297-5982\n" +
                        "\n" +
                        "Para funilaria.\n" +
                        "Rua Reverendo emilio cardoso - nº64 - Freguesia do ó - São paulo.\n" +
                        "Ligue no telefone.\n" +
                        "onze - 3297-5982\n" +
                        "repetindo \n" +
                        "onze - 3297-5982.\n" +
